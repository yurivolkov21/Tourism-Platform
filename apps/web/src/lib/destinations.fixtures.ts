...
const TOUR_SUMMARIES: Record<string, string> = {
  'ha-long-bay-2d1n':
    'Cruise the limestone karst of Hạ Long Bay with a night aboard a boutique junk.',
  'ha-long-lan-ha-3d2n':
    'A slower cruise into the quieter Lan Hạ Bay — kayaks, caves and hidden lagoons.',
  'sa-pa-trek-2d1n':
    'Trek between rice terraces and Hmong villages, with a homestay night in the hills.',
  'ninh-binh-day-trip':
    'Row through the cave-pierced karst of Tam Cốc and climb to the Múa Cave view.',
  'ha-giang-loop-3d':
    'Ride the legendary Hà Giang Loop past the Mã Pí Lèng pass and frontier villages.',
  'hoi-an-old-town-1d':
    'Wander the lantern-lit old town, then float a lantern down the river at dusk.',
  'hoi-an-my-son-2d1n':
    'Pair Hội An’s old town with the red-brick Chăm towers of the Mỹ Sơn sanctuary.',
  'hue-imperial-1d':
    'Explore the walled citadel and royal tombs of the Nguyễn emperors in Huế.',
  'da-nang-ba-na-1d':
    'Ride the cable car to the Golden Bridge and the Bà Nà hills above Đà Nẵng.',
  'phong-nha-paradise-1d':
    'Boat into the river caves and trek to the vast chambers of Paradise Cave.',
  'hcmc-cu-chi-1d':
    'Crawl the Củ Chi tunnels and trace Sài Gòn’s history through its colonial centre.',
  'mekong-cai-rang-1d':
    'Drift through the Cái Răng floating market at dawn and the orchards beyond.',
  'mekong-homestay-2d1n':
    'Slow down to the rhythm of the delta with a night in a riverside homestay.',
  'phu-quoc-islands-1d':
    'Hop the An Thới islands by boat, snorkel the reefs, and end on a quiet beach.',
  'da-lat-highlands-1d':
    'Escape to the pine-clad hills, waterfalls and coffee farms of Đà Lạt.',
};
...
export const destinations: DestinationTileVM[] = [
  // ── Northern Vietnam ──────────────────────────────────────────────────────
  {
    ...
    description:
      'A UNESCO seascape of limestone karsts rising from emerald water.',
    tourCount: 8,
    ...
    tours: [
      tour(
        'ha-long-bay-2d1n',
        'Hạ Long Bay Cruise — 2 Days 1 Night',
        'Hạ Long Bay',
        2,
        320,
        4.8,
      ...
      tour(
        'ha-long-lan-ha-3d2n',
        'Hạ Long & Lan Hạ Bay — 3 Days 2 Nights',
        'Hạ Long Bay',
        3,
        540,
        4.9,
        ...
        {
          badges: ['EXCLUSIVE'],
          travelStyles: ['couples', 'luxury', 'private'],
          themes: ['cruise', 'nature'],
        },
      ),
    ],
  },
  {
    ...
    region: 'Northern Vietnam',
    description:
      'Terraced highlands and hill-tribe trails in the far northwest.',
    tourCount: 6,
    ...
    tours: [
      tour(
        'sa-pa-trek-2d1n',
        'Sa Pa Valley Trek — 2 Days 1 Night',
        'Sa Pa',
        2,
        210,
        4.7,
  ...
  },
  {
    ...
    region: 'Northern Vietnam',
    description:
      'Inland karsts, river caves, and rice fields — the “Hạ Long on land”.',
    tourCount: 5,
    ...
    tours: [
      tour(
        'ninh-binh-day-trip',
        'Ninh Bình Day Trip — Tam Cốc & Múa Cave',
        'Ninh Bình',
        1,
        90,
        4.7,
  ...
  },
  {
    ...
    region: 'Northern Vietnam',
    description:
      'Vietnam’s wild northern frontier of switchback passes and stone plateaus.',
    tourCount: 4,
  ...
  // ── Central Vietnam ───────────────────────────────────────────────────────
  {
    ...
    description:
      'A lantern-lit trading port and UNESCO old town on the Thu Bồn river.',
    tourCount: 12,
    ...
    tours: [
      tour(
        'hoi-an-old-town-1d',
        'Hội An Old Town & Lanterns — Day Tour',
        'Hội An',
        1,
        95,
        4.9,
      ...
      tour(
        'hoi-an-my-son-2d1n',
        'Hội An & Mỹ Sơn Sanctuary — 2 Days 1 Night',
        'Hội An',
        2,
        260,
        4.8,
        98,
        img(P.temple),
        { travelStyles: ['couples', 'group'], themes: ['cultural'] },
      ),
    ],
  },
  {
    ...
    region: 'Central Vietnam',
    description:
      'The former imperial capital, its citadel and royal tombs on the Perfume river.',
    tourCount: 9,
    ...
    tours: [
      tour(
        'hue-imperial-1d',
        'Huế Imperial City & Tombs — Day Tour',
        'Huế',
        1,
        110,
        4.7,
        73,
        img(P.temple),
        { travelStyles: ['family', 'group'], themes: ['cultural'] },
      ),
    ],
  },
  {
    ...
    region: 'Central Vietnam',
    description:
      'A beach city of golden sands, the Marble Mountains, and the Bà Nà hills.',
    tourCount: 7,
  ...
  },
  {
    ...
    tours: [
      tour(
        'phong-nha-paradise-1d',
        'Phong Nha & Paradise Cave — Day Tour',
        'Phong Nha',
        1,
        135,
        4.8,
  ...
  // ── Southern Vietnam ──────────────────────────────────────────────────────
  {
    ...
    description:
      'The energetic southern metropolis of history, markets, and street food.',
    tourCount: 10,
  ...
  },
  {
    ...
    region: 'Southern Vietnam',
    description:
      'A maze of rivers, floating markets, and orchards in the deep south.',
    tourCount: 7,
    ...
    tours: [
      tour(
        'mekong-cai-rang-1d',
        'Cái Răng Floating Market — Day Tour',
        'Mekong Delta',
        1,
        85,
        4.6,
        ...
        img(P.river),
        {
          badges: ['BEST_VALUE'],
          travelStyles: ['family', 'group'],
          themes: ['cultural', 'culinary', 'nature'],
        },
      ),
      tour(
        'mekong-homestay-2d1n',
        'Mekong Homestay — 2 Days 1 Night',
        'Mekong Delta',
        2,
        180,
        4.8,
        67,
        img(P.city),
        { travelStyles: ['family', 'couples'], themes: ['cultural', 'nature'] },
      ),
    ],
  },
  {
    ...
    region: 'Southern Vietnam',
    description:
      'Vietnam’s largest island — white-sand beaches and clear southern seas.',
    tourCount: 5,
    ...
    tours: [
      tour(
        'phu-quoc-islands-1d',
        'Phú Quốc Island Hopping — Day Tour',
        'Phú Quốc',
        1,
        99,
        4.7,
        ...
        {
          badges: ['POPULAR'],
          travelStyles: ['couples', 'family', 'luxury'],
          themes: ['beach', 'nature'],
        },
      ),
    ],
  },
  {
    ...
    region: 'Southern Vietnam',
    description:
      'A cool-climate highland retreat of pine forests, lakes, and flower farms.',
    tourCount: 4,
    ...
    tours: [
      tour(
        'da-lat-highlands-1d',
        'Đà Lạt Highlands & Waterfalls — Day Tour',
        'Đà Lạt',
        1,
        80,
        4.6,
        61,
        img(P.terraces),
        { travelStyles: ['couples', 'family'], themes: ['nature'] },
      ),
    ],
  },
];
...
export const popularTours: TourCardData[] = [
  tour(
    ...
    124,
    img(P.halong),
    { compareAtPrice: 390, badges: ['BEST_VALUE'] },
  ),
  tour(
    'hoi-an-old-town-1d',
    'Hội An Old Town & Lanterns — Day Tour',
