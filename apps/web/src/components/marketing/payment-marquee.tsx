  ...
  return (
    <div>
      ...
      <div aria-hidden className="relative overflow-hidden">
        ...
        <div className="from-card pointer-events-none absolute inset-y-0 left-0 w-1/6 bg-linear-to-r to-transparent" />
        <div className="from-card pointer-events-none absolute inset-y-0 right-0 w-1/6 bg-linear-to-l to-transparent" />
      </div>
