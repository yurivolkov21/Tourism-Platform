...
const MD_COMPONENTS: Components = {
  ...
  h4: (props) => (
    <h4
      className="text-foreground mt-6 mb-2 font-semibold first:mt-0"
      {...props}
    />
  ),
  p: (props) => (
    <p
      className="text-muted-foreground mb-4 leading-relaxed text-pretty last:mb-0"
      {...props}
    />
  ),
  strong: (props) => (
  ...
  ul: (props) => (
    <ul className="mb-4 list-disc space-y-1.5 pl-5 last:mb-0" {...props} />
  ),
  ol: (props) => (
    <ol className="mb-4 list-decimal space-y-1.5 pl-5 last:mb-0" {...props} />
  ),
  ...
  code: (props) => (
    <code className="bg-muted rounded px-1.5 py-0.5 text-[0.9em]" {...props} />
  ),
  table: (props) => (
  ...
  td: (props) => (
    <td className="border-border/40 border-b px-3 py-2 align-top" {...props} />
  ),
};
