...
export class CancellationRequestSummaryDto {
  @ApiProperty({
    ...
    example: CancellationRequestStatus.REQUESTED,
  })
...
export class AdminCancellationRequestDto {
  ...
  @ApiProperty({ enum: CancellationRequestStatus })
  status!: CancellationRequestStatus;
  ...
  @ApiProperty({ type: AdminCancellationBookingRefDto })
  booking!: AdminCancellationBookingRefDto;
}

export class PaginatedCancellationRequestsDto {
  @ApiProperty({ type: [AdminCancellationRequestDto] })
  data!: AdminCancellationRequestDto[];
