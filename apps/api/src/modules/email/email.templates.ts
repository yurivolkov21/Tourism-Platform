...
// Gmail collapses plain nbsp runs - the combining-char mix below survives,
// keeping the snippet on the preheader copy (never the N letter-mark).
const PREHEADER_PAD = '&#847;&zwnj;&nbsp;'.repeat(120);

const button = (label: string, url: string): string =>
  `<table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto"><tr><td align="center" style="border-radius:8px;background:${C.brand}"><a href="${url}" style="display:inline-block;max-width:280px;padding:16px 28px;font-family:${FONT};font-size:16px;font-weight:500;line-height:24px;color:#ffffff;text-decoration:none;text-align:center;border-radius:8px">${label}</a></td></tr></table>`;
