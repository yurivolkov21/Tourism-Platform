 ...
 * Server Component throw, and that's fine — the proxy refreshes the session on the next request.
 */
      ...
      cookies: {
        ...
        setAll(cookiesToSet) {
          try {
            ...
            // Called from a Server Component — safe to ignore; the proxy handles the refresh.
          }
        },
      },
    },
