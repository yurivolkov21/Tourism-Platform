...
export const destinationSchema = z.object({
  ...
  region: z.string().trim().max(80, 'Region must be 80 characters or fewer').optional(),
...
export function toDestinationPayload(input: DestinationInput): Record<string, unknown> {
