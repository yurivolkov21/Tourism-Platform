...
## Payments (multi-gateway) — [ADR-0006](../decisions/0006-multi-gateway-momo.md) (Stripe + **PayPal**)
...
[../reference/functions-admin.md](../reference/functions-admin.md) ·
[functions-customer.md](../reference/functions-customer.md) ·
[functions-system.md](../reference/functions-system.md).
