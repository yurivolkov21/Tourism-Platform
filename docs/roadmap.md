...
| 🚧 **P1.4** | CRUD: **destinations ✅** · **tours ✅** (+categories, +itinerary/FAQs/policies, **+M:N**) · departures | sub-phased: P1.4a destinations + P1.4b tours/categories done; P1.4c departures next. M:N + slug refs change DTO shape vs donor |
