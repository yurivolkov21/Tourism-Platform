...
| **P3** | Web (customer): marketing · catalogue · booking · account | ✅ complete + deployed (Vercel) — all surfaces on real data, booking money-path live (Stripe/PayPal + private requests), a11y/SEO/perf polish done, brand chrome admin-managed. Debt program W1→W4 CLOSED 2026-07-12 (W4: shared AuthFormField · all 17 forms noValidate · auth titles i18n). Contact Launcher 2026-07-14 (WhatsApp deep-link + enquiry popover, env-driven). Current surface map: [frontend.md](01-architecture/frontend.md). **291 tests.** |
