...
export const messages = {
  ...
  mobile: {
    auth: {
      loginTitle: 'Log in',
      loginSubtitle: 'Welcome back — sign in to see your trips and saved tours.',
      registerTitle: 'Create account',
      registerSubtitle: 'Sign up to book tours and save your favorites.',
      fullNameLabel: 'Full name',
      emailLabel: 'Email',
      passwordLabel: 'Password',
      ...
      logInLink: 'Log in',
      checkInboxTitle: 'Check your inbox',
      checkInboxBody: "We've sent a confirmation link to your email. Confirm it, then log in.",
      backToLogin: 'Back to log in',
      genericValidationError: 'Enter your email and password.',
      nameTooShort: 'Enter your full name.',
      passwordTooShort: 'Password must be at least 6 characters.',
      passwordMismatch: 'Passwords do not match.',
      signInPromptTrips: 'Sign in to see your trips',
      signInPromptTripsHint: 'Log in to view and manage your bookings.',
      signInPromptSaved: 'Sign in to see your saved tours',
      signInPromptSavedHint: 'Log in to keep track of tours you love.',
      signInCta: 'Log in',
      signOut: 'Sign out',
    },
    tabs: {
    ...
    // Mobile Saved tab (wishlist) — keep copy aligned with web "Saved for later".
    saved: {
    ...
    more: {
      ...
      footerTagline: 'Discover Vietnam with confidence.',
      ...
      accountCard: {
        title: 'Your account',
        comingSoon: 'Account sign-in is coming to the mobile app soon.',
      },
      account: 'Account',
      payment: 'Payment',
      settings: 'Settings',
      logout: 'Logout',
      menuComingSoon: 'This feature is coming to the mobile app soon.',
    },
    tours: {
      ...
      menuLabel: 'Menu',
      menuComingSoon: 'Quick menu is coming to the mobile app soon.',
      notificationsLabel: 'Notifications',
      notificationsComingSoon: 'Notifications are coming to the mobile app soon.',
      searchPlaceholder: 'Search tours or destinations…',
      foundTours: (n: number) => `Found ${n} ${n === 1 ? 'tour' : 'tours'}`,
      refineLabel: 'Filter and sort tours',
      searchRecentLabel: 'Recent',
      topRecommendedLabel: 'Top recommended',
      browseTabs: {
        tours: 'Tours',
        destinations: 'Destinations',
      },
      destinationsEmpty: 'Destinations are coming to the mobile app soon.',
      searchNoResults: {
        tourTitle: 'Tour not found',
        destinationTitle: 'Destination not found',
        hint: 'Try search with a different keyword',
      },
      empty: 'No matching tours found.',
      ...
      contactAboutTour: 'Ask about this tour',
    },
    destinations: {
      filtersLabel: 'Filters',
      sortLabel: 'Sort',
      viewModeLabel: 'View mode',
      refineLabel: 'Filter and sort destinations',
      clearAll: 'Clear all',
      foundDestinations: (n: number) =>
        `Found ${n} destination${n === 1 ? '' : 's'}`,
      resultCount: (n: number) => `${n} destination${n === 1 ? '' : 's'}`,
      tourCount: (n: number) => `${n} tour${n === 1 ? '' : 's'}`,
      viewTours: 'View tours',
      saveDestination: 'Save destination',
      unsaveDestination: 'Remove from saved',
      facets: {
        region: 'Region',
      },
      regionLabels: {
        ...
        short: {
          ...
          'Southern Vietnam': 'Southern',
        },
      },
      sortOptions: {
        toursDesc: 'Most tours',
        nameAsc: 'Name A–Z',
        nameDesc: 'Name Z–A',
      },
      viewModeOptions: {
    ...
    trips: {
      ...
      emptyHint: 'Tours you book will show up here.',
      exploreCta: 'Explore tours',
      searchLabel: 'Search bookings',
      searchPlaceholder: 'Search your bookings…',
      searchEmpty: 'No bookings match your search.',
      loading: 'Loading your bookings…',
      error: 'Could not load your bookings.',
      retry: 'Try again',
      payDemo: 'Secure checkout is coming soon — this is a UI preview with sample data.',
      cancelDemo: 'Cancellation will connect to the API in a later phase — preview only.',
      requestDemo: 'Refund requests will be handled in-app later — preview only.',
    },
    faq: {
      searchPlaceholder: 'Search questions…',
    },
