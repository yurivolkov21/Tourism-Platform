...
export const messages = {
  ...
  mobile: {
    ...
    saved: {
      ...
      emptyHint: 'Try adding some tours to your bookmarks.',
      searchLabel: 'Search saved tours',
      searchComingSoon: 'Search is coming to the mobile app soon.',
      empty: 'You haven’t saved any tours yet.',
    },
    more: {
      support: 'Support',
    ...
    tours: {
      ...
      viewTour: 'View tour',
      toursInDestination: (name: string) => `Tours in ${name}`,
