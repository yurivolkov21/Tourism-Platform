import { daysUntil, summarizeBookings, type DashboardBooking } from './dashboard.js';
...
describe('summarizeBookings', () => {
  it('counts active upcoming, paid completed, and total', () => {
    const stats = summarizeBookings(
      [
        booking('PAID', '2026-07-09', 'A'),
        booking('PENDING', '2026-08-01', 'B'),
        booking('PAID', '2026-05-01', 'C'),
        booking('CANCELLED', '2026-04-01', 'D'),
      ],
      NOW,
    );
