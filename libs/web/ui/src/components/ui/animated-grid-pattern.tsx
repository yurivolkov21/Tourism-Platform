 ...
 * (`--muted-foreground`) instead of a hard-coded grey so it stays on-palette; override via
 * `className` (`stroke-*`, `text-*`) at the call site. The animated squares fade in/out — wrap with
 * `motion-reduce:hidden` where reduced motion should drop them.
 */
